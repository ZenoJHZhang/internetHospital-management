...
var RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function () {
        ...
        function DetectLocalIPAddress(callback, stream) {
            if (DetectRTC.isWebRTCSupported) {
                var isPublic = !0,
                    isIpv4 = !0;
                getIPs(function (ip) {
                    ip.match(regexIpv4Local) ? (isPublic = !1, callback("Local: " + ip, isPublic, isIpv4)) : ip.match(regexIpv6) ? (isIpv4 = !1, callback("Public: " + ip, isPublic, isIpv4)) : callback("Public: " + ip, isPublic, isIpv4)
                }, stream)
            }
        }
        ...
        DetectRTC.browser.isFirefox && DetectRTC.browser.version >= 43 && (isMultiMonitorScreenCapturingSupported = !0), DetectRTC.isMultiMonitorScreenCapturingSupported = isMultiMonitorScreenCapturingSupported, DetectRTC.isPromisesSupported = !!("Promise" in window), DetectRTC.version = "1.3.7", "undefined" == typeof DetectRTC && (window.DetectRTC = {});
    ...
    var OnIceCandidateHandler = function () {
        ...
        IceServersHandler = function () {
            function getIceServers(connection) {
                var iceServers = [{
                    urls: ["stun:webrtcweb.com:7788", "stun:webrtcweb.com:7788?transport=udp"],
                    username: "muazkh",
                    credential: "muazkh"
                }, {
                    urls: ["turn:webrtcweb.com:7788", "turn:webrtcweb.com:4455?transport=udp", "turn:webrtcweb.com:8877?transport=udp", "turn:webrtcweb.com:8877?transport=tcp"],
                    username: "muazkh",
                    credential: "muazkh"
                }, {
                ...
                return "undefined" != typeof window.InstallTrigger && (iceServers = [{
    ...
    ! function (connection) {
        ...
        }, connection.trickleIce = !0, connection.version = "3.6.2", connection.onSettingLocalDescription = function (event) {
